...
export const HistoryPanel = () => {
    ...
    return (
        <div className="absolute top-4 right-4 p-3 bg-black/90 backdrop-blur-sm rounded-lg shadow-lg z-10">
            {/* Model Info */}
            <div className="mb-3 text-xs">
                <p className="text-gray-400 truncate max-w-48" title={vrmFileName || ''}>
                    📁 {vrmFileName || 'Unknown'}
                </p>
            ...
            {/* History count - shows actions, not snapshots */}
